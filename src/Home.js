...
import card1 from '../src/assets/img2/ser1.png' 
import card2 from '../src/assets/img2/ser2.png' 
    ...
    <div className="row align-items-center">
      <div className="col-md-6 col-lg-6 col-sm-12">
        <div className="hero-slider-content text-white pt-5">
          ...
          <p className="lead"><i className="fa fa-check check-2 ico" />10+ Years Of Experience in Academic Writing
          </p>
          <p className="lead"><i className="fa fa-check check-2 ico" />Best Assignment Writer
          </p>
          <p className="lead"><i className="fa fa-check check-2 ico" />Global Assignment Helper
          </p>
          <p className="lead"><i className="fa fa-check check-2 ico" />5,067 Academic Assignment Writers
          </p>
          <div className="action-btns mt-3">
            <a href="#" className="btn primary-bg text-light mr-4">Login</a>
            <a href="#" className="btn primary-bg text-light">Register Now</a>
          </div>
        </div>
      </div>
      <div className="col-md-6 col-sm-12 col-lg-6">
        <div className="image-wrap pt-5 mt-5 text-center">
          ...
          <form action>
            ...
            <br />
            <input type="number" className="p-2" placeholder="Enter Your Number" style={{width: '81%'}} /><br />
            <br />
            <input type="text" name="course" className="p-2" placeholder="Course/Codes/Subject" id size={30} style={{width: '81%'}} /><br />
            <br />
            <input type="number" className="p-2" placeholder="No of Pages" id style={{width: '81%'}} size={60} /><br />
            <br />
            <input type="date" className="p-2" name="age" placeholder="Enter your Age" id size={60} style={{width: '81%'}} /><br />
            <br />
  ...
  <div className="container">
    <div className="row">
      <div className="col-12 text-center numbers">
       <a href="/" className='btn btn-pill primary-bg text-dark bor'><p>It,s in the number</p></a> 
...
<div className="top mb-3">
  <h2 className="text-center"><span className="heading">The</span> Assignment <span className="heading">Writing</span></h2>
  <span className="animate-border mr-auto ml-auto mb-4" />
  <p className="text-center">Get Assignment Help From World’s No.1 Assignment Help Company</p>
</div>
...
<div className="container">
  <h3 className="text-center">THE ASSIGNMENT WRITING TO MEET COURSEWORK OBLIGATIONS</h3>
  <span className="animate-border mr-auto ml-auto mb-4" />
  <p className="para22">Working on assignments can be a challenging and exciting learning experience. It allows students to
    ...
    they require special help in working on such tasks. With adequate educational support, a student can
    prosper and achieve their life goals. We are here to provide reliable</p>
  <h3 className="text-center">CHALLENGES IN ACADEMIC ASSIGNMENT WRITING</h3>
  <span className="animate-border mr-auto ml-auto mb-4" />
  <p className="para22">Students face a host of unique challenges when it comes to working on academic assignments. The first
    challenge for some students is that they fail to understand the concepts taught in class. These are
    sometimes students with learning disabilities or international students as well. As such, these students
    are likely to struggle in producing assignments that can get good grades.</p>
  <p className="para22">Furthermore, students also have obligations such as work, or complications such as health. These issues
    can affect the students’ ability to set aside time to work on school projects. Besides that, the number
    of scam services out there is also appalling. Some of these writing platforms are known for submitting
    poor work to clients. The Assignment Writing and more.</p>
  <h3 className="text-center">THE SOLUTION</h3>
  <span className="animate-border mr-auto ml-auto mb-4" />
  <p className="para22">The ideal solution, in this case, would be the student to invest in a reliable assignment help platform.
    We are here to help you work such projects and more. You fill out the simple order form and get assigned
    to one of our writers at the The Assignment Writing site. More so, before settling on a particular
    academic service, we recommend that you evaluate the site for the best academic outcomes. A good
    assignment writing service is professional and can respond to your queries fast.</p>
</div>
    ...
    <div className="row justify-content-center">
      <div className="col-md-8">
        <div className="section-heading text-center mb-5">
          <h1>Total $ 0 </h1>
          <span className="animate-border mr-auto ml-auto mb-4" />
          <h2>Features of Our Assignment Service</h2>
          <span className="animate-border mr-auto ml-auto mb-4" />
        </div>
      </div>
    </div>
    <div className="row">
      <div className="col-lg-4 col-md-6 col-sm-6">
        <div className="services-single text-center p-5 my-md-3 my-lg-3 my-sm-0 shadow-sm white-bg rounded">
          ...
          <p className="mb-0">Being the best professional writing services provider, we never compromise
            when it comes to deadline and delivery of assignment on time. Our writers make sure that
      ...
      <div className="col-lg-4 col-md-6 col-sm-6">
        <div className="services-single text-center p-5 my-md-3 my-lg-3 my-sm-0 shadow-sm white-bg rounded">
          ...
          <p className="mb-3">We work 24x7 for your convenience. Our customer support executives are
            available round the clock in case you need any professional assistance. Feel free to
            contact our assignment writing services any time via phone, email or live chat..</p>
          <br />
          <br />
          <br />
        </div>
      ...
      <div className="col-lg-4 col-md-6 col-sm-6">
        <div className="services-single text-center p-5 my-md-3 my-lg-3 my-sm-0 shadow-sm white-bg rounded">
          ...
          <p className="mb-2">Knowledge, experience and creativity are three features we consider before
            hiring a writer. All our professional writers have acquired Ph.D. credentials from
            reputed universities across the world. We have writers for each and every subject and
            always help, always get in touch with us.</p>
          <br />
          <br />
      ...
      <div className="col-lg-4 col-md-6 col-sm-6">
        <div className="services-single text-center p-5 my-md-3 my-lg-3 my-sm-0 shadow-sm white-bg rounded">
          ...
          <p className="mb-3">It does not matter whether you are a freshman in college or finishing your
            final assignment to acquire Ph.D. degree, our writers can provide you professional
      ...
      <div className="col-lg-4 col-md-6 col-sm-6">
        <div className="services-single text-center p-5 my-md-3 my-lg-3 my-sm-0 shadow-sm white-bg rounded">
          ...
          <p className="mb-2">To avoid any plagiarism, we check our completed papers three times — after
            writing, editing and proofreading — using reliable plagiarism detection software, .
            plagiarism. We only provide customized 100 percent original papers</p>
          <br />
          <br />
          <br />
        </div>
      ...
      <div className="col-lg-4 col-md-6 col-sm-6">
        <div className="services-single text-center p-5 my-md-3 my-lg-3 my-sm-0 shadow-sm white-bg rounded">
          ...
          <p className="mb-0">You get premium service at the best market price. Our best price guarantee
            ensures that the features we offer cannot be matched by any of the competitors, in case
            they do - “We will beat the price”. Thus, for an effective and cheap assignment help,
...
<div className="container  Team text-center">
  <div className="row justify-content-center mt-50px ">
    <div className="col-lg-6 col-md-6 col-sm-12 ">
      <p className="student ">72% of students use assignment help services at least once. You just have to
        choose a quality
        writing company.</p>
    </div>
  </div>
  <div className="row mt-4">
    <div className="col-lg-6 col-md-6 col-sm-12 ">
      ...
      <h2>UK Team</h2>
      <p className="uk">We've been called the UK's premier<br /> essay writing service for a good
        reason:<br /> our dedication to providing students with<br /> an affordable, quality service</p>
    </div>
    <div className="col-lg-6 col-md-6 col-sm-12 ">
      <img src={icon2} alt width={46} height={52} />
      <h2>Guarantees</h2>
      <p className="uk ">Our quality guarantees offer you peace of<br /> mind about the work you receive
        from us<br /> and assurance that your personal and<br /> payment details are safe and secure.
      </p>
    </div>
  </div>
  {/* row 1 complete */}
  <div className="row mt-4">
    <div className="col-lg-6 col-md-6 col-sm-12 ">
      ...
      <p>We rigorously test our writers and check their qualifications and experience before engaging
        them and periodically review their work to ensure the highest standards are maintained.</p>
    </div>
    <div className="col-lg-6 col-md-6 col-sm-12 ">
      <img src={icon4} alt width={59} height={52} />
      <h2>Care Centre</h2>
      <p>We have a dedicated team of customer representatives available 24/7 to any your questions
        about any aspect of our products and services.</p></div>
  </div>
</div>
      ...
      <div className="row  justify-content-around mn">
        <div className="col-md-3 sha  shadow mt-4">
          ...
          <p className="provide">We provide most reliable and proficient service to help you work on those
            ...
            Our Ph.D. experts carry a distinctive mode of expression assisting students to write flawless
            papers.</p>
        </div>
        <div className="col-md-3 sha shadow mt-4">
          ...
          <p className="provide-1">We offer premium essay writing help in a customised manner. Our Native essay
            ...
            university standards in terms of writing and structuring of academic essays and gain academic
            excellence.</p>
        </div>
        <div className="col-md-3 sha shadow mt-4">
          ...
          <p className="provide-1">We offer distinctive service in detailed research for your dissertation on any
            topic from any
            subject. Our experts help you select appropriate methodology to research ensuring valid and
            reliable results.</p>
        </div>
        <div className="col-md-3 sha shadow mt-4">
          ...
          <h2 className="help-1 ico"><b>Custom Coursework Help</b></h2><b>
            <p className="provide-1">We provide dependable coursework help to meet your writing needs in a
              customized manner. Whether
              it is homework help, case study or online exam help we have authentic writers ensuring
              excellence.</p>
          </b></div><b>
        </b></div><b>
        {/* end */}
 ...
 <div className="container join">
  <div className="row">
    <div className="col-md-3 col-sm-12">
      <h5><span className="ico">Business Writing</span></h5>
    ...
    <div className="col-md-3 col-sm-12">
      <h5><span className="ico">Web Content Writing</span></h5>
      <p>Web Copy Writing
        Product Description
        White Paper Writing
    ...
    <div className="col-md-3  col-sm-12">
      <h5><span className="ico"> Personal Writing</span></h5>
      <p>Resume Writing
        Cover Letters
    ...
    <div className="col-md-3  col-sm-12 join-2">
      <h5><span className="ico">SEO Content Writing</span></h5>
      <p>Article Writing
        Product Reviews
        SEO Blog Writing
    ...
    <div className="col-md-3  col-sm-12 join-2">
      ...
      <i className="fa fa-twitter social-1" />
...
<div className="container-fluid">
  <div className="row post">
    <div className="col-md-4">
      <br />
      <h2 className="writting">Assignment<br />Writting</h2>
    </div>
    <div className="col-md-4">
      <br />
      <h3 className="writting">Visit<br /> Website</h3>
    ...
    <div className="col-md-4 ">
      <br />
      <h3 className="writting">Contect Us</h3>
