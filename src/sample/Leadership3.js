...
<div>
  ...
  <div className="main">
    ...
    <div className="container">
      <h3 className="text-center ico" style={{borderBottom: '12px solid black'}}>Report on Effects Of Leadership
      ...
      <ul>
        <li><p>To decide the idea and effect of management fashion on commercial enterprise performance.</p></li>
        <li>To check out the connection among management fashion and worker motivation and its dedication to
          carry long time productivity.<p /></li>
        <li><p>To get entry to the results of management over companies’ capacity to hold employees, enhancement in
            morale and productivity.</p></li>
        <li><p>To examine that at which volume management fashion and practices impacts people performance.</p></li>
      </ul>
      ...
      <p>According to O’Regan 2018, that is the time period that defines the reason of the studies which may be
        categorized in 3:</p>
      <ul>
        <li><p><b>Exploratory observe-</b> A observe that has now no longer been studied extra clearly, or you're
            uncertain approximately the character of the problem.</p>
        </li>
        <li><p><b>Descriptive examine-</b> A examine that has been studied before, wherein you're positive
            approximately
            the character of the problem, or wherein you've got got the correct profile on persons, occasions or
            situation.</p></li>
        <li><p><b>Explanatory examine–</b>A examine and is the reason the connection among variables following
            analysis.</p></li>
      </ul>
      ...
      <ul>
        <li><p><b>Questionnaire:</b> Questionnaire is the method of collecting data in which every respondent is
            ...
            right to stay anonymous. Whereas, interviews are time consuming and difficult to analyse.</p>
        </li>
        <li><p><b>Data evaluation approach:</b> I even have used Univariate analysiswhich way to examine one
            variable at a
            ...
            relationships or causes (Kumar, R. 2011).</p></li>
      </ul>
      <p>4.5 Sample Size:
      </p>
      ...
      <ul>
        <li><p><b>Participants and consent-</b> All individuals get hold of player data sheets, a records
            ...
            retained through the studies team.</p></li>
        <li><p><b>Permission-</b> From the HR Manager at Maharani will be sought in order to approach participants
            and use the premises to conduct the interview.</p>
        </li>
        <li><p><b>Confidentiality and anonymity-</b>Participant’s contribution will be confidential and anonymised
            if they wish so, in such case anonymous names will be used to complete the questionnaire.</p>
        </li>
        <li><p><b>Vulnerable populations–</b>All individuals are over 18 and are employees.</p></li>
        <li><p><b>Deception-</b> Consistent with participatory studies methods, the ones worried withinside the
            studies
            could be absolutely knowledgeable of the cause of the studies and could be given get admission to to
            the effects of the studies previous to wider dissemination.</p></li>
      </ul>
      ...
      <ul>
        <li><p>Kumar, Ranjit. Research methodology: A step-by-step guide for beginners. Sage Publications Limited, 2011.</p>
        </li>
        <li><p>McColl-Kennedy, J.R. and Anderson, R.D., 2002. Impact of leadership style and emotions on subordinate performance. The leadership quarterly, 13(5), pp.545-559.</p>
        </li>
        <li><p>Bhatti, N., Maitlo, G.M., Shaikh, N., Hashmi, M.A. and Shaikh, F.M., 2012. The impact of autocratic and democratic leadership style on job satisfaction. International Business Research, 5(2), p.192.</p>
        </li>
        <li><p>Laudan, L., 1996. Beyond positivism and relativism: Theory, method, and evidence.</p>
        </li>
        <li><p>Hyde, K.F., 2000. Recognising deductive processes in qualitative research. Qualitative market research: An international journal, 3(2), pp.82-90.</p>
        </li>
        <li><p>Sethibe, T.G., 2018. Towards a comprehensive model on the relationship between leadership styles, organisational climate, innovation and organisational performance. International Journal of Innovation Management. 22(02). p.1850021.</p>
        </li>
        <li><p>Buil, I., Martínez, E. and Matute, J., 2019. Transformational leadership and employee performance: The role of identification, engagement and proactive personality. International Journal of Hospitality Management. 77. pp.64-75.</p>
        </li>
        <li><p>Amin, W and et.al., 2018. Impact of Transformation Leadership on Affective Employee’s Commitment. European Online Journal of Natural and Social Sciences: Proceedings. 7(1 ). pp.pp-48.</p>
        </li>
        <li><p>Hussain, S.T and et.al., 2018. Kurt Lewin’s change model: A critical review of the role of leadership and employee involvement in organizational change. Journal of Innovation &amp; Knowledge. 3(3). pp.123-127.</p>
        </li>
      </ul>
    </div>
  </div>
