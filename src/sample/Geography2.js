...
<div>
  ...
  <div className="main">
        ...
        <div className="row align-items-center justify-content-center">
          <div className="col-md-9 col-lg-7">
            <div className="page-header-content text-white text-center pt-sm-5 pt-md-5 pt-lg-0">
              <h2 className="text-white mb-0">Effects of Globalization
              </h2>
    ...
    <div className="container">
      <h3 className="text-center effect ico" style={{borderBottom: '12px solid black'}}>Report on Effects of Globalization
      </h3>
      ...
      <ul>
        <li><p>Hosseini, H., 2005. An Economic Theory of FDI: A Behavioural Economics and Historical Approach. The
            Journal of Socio-Economics.</p>
        </li><li><p>O’Sullivan, N., 2008. Concept and Reality in Globalization, Privatization, and Free Market Economy,
            Westport, CT. Quorum Books/Greenwood.</p>
        </li>
        <li><p>Seddon, T., 2008. Drugs, the informal economy and globalization. International Journal of Social
            Economics.</p>
        </li>
        <li><p>Gabrielsson, P., Darling, J. and Luostarinen, R., 2006. Globalizing internationals: product
            strategies of ICT manufacturers. International Marketing Review.</p>
        </li>
        <li><p>Hosseini, H., 2005. An Economic Theory of FDI: A Behavioural Economics and Historical Approach. The
            Journal of Socio-Economics.</p>
        </li>
        <li><p>Hill, C. and Cronk, T., 2010. Global Business. McGraw Hill/Irwin.</p>
        </li>
        <li><p>Walker, C., 2008. Depression And Globalization: The Politics Of Mental Health In The 21st Century.
            Springer.</p>
        </li>
        <li><p>Mack, K., 2010. A forgotten history: The impacts of globalization on Norwegian seafarers’ shipboard
            organizational lives. Journal of Management History.</p>
        </li>
        <li><p>Jens-Uwe,W. and Meera W., 2009. A Dictionary of Globalization. Taylor &amp; Francis.</p>
        </li>
      </ul>
    </div>
  </div>
