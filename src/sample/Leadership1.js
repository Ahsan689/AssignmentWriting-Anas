...
<div>
  ...
  <div className="main">
        ...
        <div className="row align-items-center justify-content-center">
          <div className="col-md-9 col-lg-7">
            <div className="page-header-content text-white text-center pt-sm-5 pt-md-5 pt-lg-0">
              <h2 className="text-white mb-0">Free Samples of Language
              </h2>
    ...
    {/*hero section end*/}
    <div className="container">
      <h2 className="text-center">Get the Best Leadership to Improve Your Grade
      </h2>
      ...
      <div className="row row-4 justify-content-around">
        <div className="col-md-5 card">
          {/* sub row start */}
          <h3 className="text-center"><Link to="/Leadership2">Principle And Practices of Leadership And Management,Module Code:6HR503</Link></h3>
          <div className="row">
        ...
        <div className="col-md-5 card">
          <h3 className="text-center"><Link to="/Leadership3">Effect of Leadership Style On Employee Motivation</Link></h3>
          <div className="row">
            <div className="col-md-8">
              <h5>Numbers of Pages:</h5>
            </div>
