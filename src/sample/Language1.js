...
<div>
  ...
  <div className="main">
    ...
    {/*hero section end*/}
    <div className="container">
      <h2 className="text-center">Get the Best Language to Improve Your Grade
      </h2>
      ...
      <div className="row row-4 justify-content-around">
        <div className="col-md-5 card">
          {/* sub row start */}
          <h3 className="text-center"><Link to="/Language2">Women's Language</Link></h3>
          <div className="row">
        ...
        <div className="col-md-5 card">
          <h3 className="text-center"><Link to="/Language3">English Language Style</Link></h3>
          <div className="row">
            <div className="col-md-8">
              <h5>Numbers of Pages:</h5>
            </div>
