...
<div>
  ...
  <div className="main">
        ...
        <div className="row align-items-center justify-content-center">
          <div className="col-md-9 col-lg-7">
            <div className="page-header-content text-white text-center pt-sm-5 pt-md-5 pt-lg-0">
              <h2 className="text-white mb-0">Free Samples of Education
              </h2>
    ...
    {/*hero section end*/}
    <div className="container">
      <h2 className="text-center">Get the Best Education to Improve Your Grade
      </h2>
      ...
      <div className="row row-4 justify-content-around">
        <div className="col-md-5 card">
          {/* sub row start */}
          <div className="row">
            <h3 className="text-center"><Link to="/Education2">Unit 1:Understanding roles,Responsibilities
                Education and Traning Levl3 </Link></h3>
        ...
        <div className="col-md-5 card">
          <h3 className="text-center"><Link to="/Education3">Student Plagiarism And Professional Practice</Link>
          </h3>
          <div className="row">
            <div className="col-md-8">
              <h5>Numbers of Pages:</h5>
      ...
      <div className="row row-4 justify-content-center">
        <div className="col-md-5 card">
          <h3 className="text-center"><Link to="/Education4">Reflective Essay </Link></h3>
          <div className="row">
            <div className="col-md-8">
              <h5>Numbers of Pages:</h5>
            </div>
