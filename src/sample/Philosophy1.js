...
export default function Philosophy1() {
    return (
<div>
    <Header/>
  ...
  <div className="main">
        ...
        <div className="row align-items-center justify-content-center">
          <div className="col-md-9 col-lg-7">
            <div className="page-header-content text-white text-center pt-sm-5 pt-md-5 pt-lg-0">
              <h2 className="text-white mb-0">Free Samples of Philosophy
              </h2>
    ...
    {/*hero section end*/}
    <div className="container ">
      <h2 className="text-center">Get the Best Philosophy to Improve Your Grade
      </h2>
      ...
      <div className="row row-4 justify-content-center">
        <div className="col-md-6 text- card">
          {/* sub row start */}
          <h3 className="text-center"><Link to="/Philosophy2">Propositional knowledge</Link></h3>
          <div className="row">
