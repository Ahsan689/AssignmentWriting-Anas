...
export default function Economics3() {
    return (
<div>
  ...
  <div className="main">
        ...
        <div className="row align-items-center justify-content-center">
          <div className="col-md-9 col-lg-7">
            <div className="page-header-content text-white text-center pt-sm-5 pt-md-5 pt-lg-0">
              <h2 className="text-white mb-0">Ecomomics
              </h2>
    ...
    <br />
    <div className="container">
      <h3 className="text-center ico" style={{borderBottom: '12px solid  black'}}>Report on Ecomomics
      </h3>
      <p>Introduction
      </p>
      ...
      <p><b>Aggregate demand:</b> Aggregate demand curve shows that total demand for goods and services in
        ...
        Bekker‐Grob, Ryan, and Gerard,, 2012.) . . Another reasons for downward sloping demand curve is import
      ...
      <ul>
        <li><p>Tribe, J., 2015.The economics of recreation, leisure and tourism. Routledge.</p>
        </li>
        <li><p>Davis, J. B., 2013.The theory of the individual in economics: Identity and value. Routledge.</p>
        </li>
        <li><p>Barberis, N. C., 2013. Thirty years of prospect theory in economics: A review and assessment.The Journal of Economic Perspectives. 27(1). pp.173-195.</p>
        </li>
        <li><p>Tullock, G., 2013.Economics of income redistribution. Springer Science &amp; Business Media.</p>
        </li>
        <li><p>Reich, P. B., 2014. The world‐wide ‘fast–slow’plant economics spectrum: a traits manifesto.Journal of Ecology. 102(2). pp.275-301.</p>
        </li>
        <li><p>Bazilian, M., Onyeji, I. and Zhengrong, S., 2013. Re-considering the economics of photovoltaic power.Renewable Energy.53. pp.329-338.</p>
        </li>
        <li><p>Meek, R. L., 2013.Economics of physiocracy. Routledge.</p>
        </li>
        <li><p>de Bekker‐Grob, E. W., Ryan, M. and Gerard, K., 2012. Discrete choice experiments in health economics: a review of the literature.Health economics. 21(2). pp.145-172.</p>
        </li>
        <li><p>Eichholtz, P., Kok, N. and Quigley, J.M., 2013. The economics of green building.Review of Economics and Statistics. 95(1). pp.50-63.</p>
        </li>
        <li><p>Stevenson, K. B., Balada-Llasat, J. M.. and West, J., 2012. The economics of antimicrobial stewardship: the current state of the art and applying the business case model.Economics. 33(4). pp.389-397.</p>
        </li>
      </ul>
    </div>
  </div>
