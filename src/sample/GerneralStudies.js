...
export default function GerneralStudies() {
    return (
<div>
    <Header/>
  ...
  <div className="main">
        ...
        <div className="row align-items-center justify-content-center">
          <div className="col-md-9 col-lg-7">
            <div className="page-header-content text-white text-center pt-sm-5 pt-md-5 pt-lg-0">
              <h2 className="text-white mb-0">Free Samples of General Studies
              </h2>
    ...
    {/*hero section end*/}
    <div className="container">
      <h2 className="text-center">Get the Best General Studies to Improve Your Grade
      </h2>
      <span className="animate-border mr-auto ml-auto mb-4" />
      {/* <i class="fas fa-arrow-circle-down"></i> */}
      <div className="row row-4 justify-content-around">
        <div className="col-md-5 card">
          <h3 className="text-center"><Link to="/GerneralStudies2">Race,gender,class and intersectionality</Link></h3>
          {/* sub row start */}
          <div className="row">
        ...
        <div className="col-md-5 card">
          <h3 className="text-center"><Link to="/GerneralStudies3">Gender Studies</Link></h3>
          <div className="row">
            <div className="col-md-8">
              <h5>Numbers of Pages:</h5>
            </div>
      ...
      <div className="row row-4 justify-content-center">
        <div className="col-md-5 card">
          <div className="row">
            <h3 className="text-center"><Link to="/GernernalStudies4">Race,gender,class and intersectionality</Link></h3>
            <div className="col-md-8">
              <h5>Numbers of Pages:</h5>
            </div>
            <div className="col-md-4">
            ...
            <div className="col-md-5">
              <h5 className="text-right">Graduate</h5>
            </div>
            <div className="col-md-7">
              <h5>Academic Level:</h5>
            </div>
