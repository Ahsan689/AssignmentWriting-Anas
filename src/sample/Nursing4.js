...
export default function Nursing4() {
    return (
<div>
    <Header/>
  ...
  <div className="main">
        ...
        <div className="row align-items-center justify-content-center">
          <div className="col-md-9 col-lg-7">
            <div className="page-header-content text-white text-center pt-sm-5 pt-md-5 pt-lg-0">
              <h2 className="text-white mb-0">The Infant Requiring Assisted Ventilation
              </h2>
    ...
    <br />
    <div className="container">
      <h3 className="text-center ico" style={{borderBottom: '12px solid black'}}>Report on The Infant Requiring
      ...
      <h4>Five priorities of nursing management
      </h4>
      ...
      <p><b>Care to new born:</b> All the toddlers are determined and people who've everyday weight and stabilized
        ...
        untimely are given unique care and are saved apprehend remark and care is supplied in line with their
        requirement.</p>
      <p><b>In accordance with the case, it is able to be commenced that Joshua become a untimely toddler and
          ...
          trouble
          of breathing after right observation.</b></p><b>
        <h3>Question 2
        </h3>
        <h4>Three potential long or short term complications of using CPAP and strategies to reduce risk
        </h4>
        ...
        <h4>Four potential long term problems that Joshua and his family due to Joshua’s preterm birth
        </h4>
