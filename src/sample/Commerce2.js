...
export default function Commerce2() {
    return (
<div>
    <Header/>
  ...
  <div className="main">
        ...
        <div className="row align-items-center justify-content-center">
          <div className="col-md-9 col-lg-7">
            <div className="page-header-content text-white text-center pt-sm-5 pt-md-5 pt-lg-0">
              <h2 className="text-white mb-0">Global Corporate Strategies
              </h2>
    ...
    <br />
    <div className="container">
      <h3 className="text-center ico" style={{borderBottom: '12px solid  black'}}>Report Global Corporate Strategies
      </h3>
      <p>Introduction
      </p>
      ...
      <p>Question 2.Retail internationalisation: Strategic alliances, M&amp;As
      </p>
      ...
      <p>Question 3.Corporate governance:
      </p>
      ...
      <p>Question 4.Impact of the global retail industry competition
      </p>
      ...
      <ul>
        <li><p>Portfolio help to manage the work of organisation.</p>
        </li>
        <li><p>It is easy to conduct and upper level management can manage it.</p>
        </li>
        <li><p>Many times portfolio does not provide the information related to organisation.</p>
        </li>
        <li><p>Many times portfolio does not provide the fully information related to the organisation.</p>
        </li>
        <li><p>Portfolio fails to save the cost of portfolio. Its increase the cost of organisation.</p>
        </li>
      </ul>
      ...
      <ul>
        <li><p>It is helpful to provide the supplementary services (Becker-Olsen and et.al, 2011).</p>
        </li>
        <li><p>It is helpful to provide the new market opportunity for new marketers.</p>
        </li>
        <li><p>It helpful to increase the brand name, brand loyalty and brand awareness in market.</p>
        </li>
        <li><p>It provide the useful information and help to select the right partner for firm or organisation.</p>
        </li>
        <li><p>Its unable to save time and consume more time to manage the work.</p>
        </li>
        <li><p>It is unable to provide the reliable result for organisation.</p>
        </li>
        <li><p>It is take more cost comparison of other.</p>
        </li>
      </ul>
      <p>
      ...
      <ul>
        <li><p>A corporate leader play a motivator role in organisation to motivate the team.</p>
        </li>
        <li><p>&gt;Corporate leader help to solve the problem in organisation.</p ></li>
          <li><p>Corporate leader work as a policy enforcer.</p>
          </li>
          <li><p>Corporate leader mange the team work and help to increase the profit in organisation.</p>
          </li>
          <li><p>Corporate leader should be a positive thinker who can manage the any situation with the great
              decision power.</p>
          </li>
        </ul>
      <p>CONCLUSION
      ...
      <ul>
        <li><p>Adriana, B., 2009. Environmental supply chain management in tourism: The case of large tour
            operators. Journal of Cleaner Production. 17(16). pp.1385-1392.</p>
        </li>
        <li><p>Andriotis, K., Agiomirgianakis, G. and Mihiotis, A., 2008. Measuring tourist satisfaction: A
            factor-cluster segmentation approach. Journal of Vacation Marketing. 14(3). pp.221-235.</p>
        </li>
        <li><p>Ateljevic, J., 2007. Small tourism firms and management practices in New Zealand: the Centre Stage
            Macro Region. Tourism Management. 28(1). pp.307-316.</p>
        </li>
        <li><p>Barnes, D., 2008. Operations management: an international perspective. Cengage Learning EMEA.</p></li>
          <li><p>Buckley, R., 2007. Adventure tourism products: Price, duration, size, skill, remoteness. Tourism
              management. 28(6). pp.1428-1433.</p>
          </li>
          <li><p>Buckley, R., 2011. Tourism and environment. Annual Review of Environment and Resources. 36.
              pp.397-416.</p>
          </li>
          <li><p>Cochrane, J. and Tapper, R., 2006. Tourism’s contribution to World Heritage Site management.
              Managing world heritage sites. pp.97-109.</p>
          </li>
        </ul>
      <h4>CONCLUSION
      </h4>
      ...
      <ul>
        <li><p>&gt;Adriana, B., 2009. Environmental supply chain management in tourism: The case of large tour operators. Journal of Cleaner Production. 17(16). pp.1385-1392.</p></li>
          <li><p>Andriotis, K., Agiomirgianakis, G. and Mihiotis, A., 2008. Measuring tourist satisfaction: A factor-cluster segmentation approach. Journal of Vacation Marketing. 14(3). pp.221-235.</p>
          </li>
          <li><p>Ateljevic, J., 2007. Small tourism firms and management practices in New Zealand: the Centre Stage Macro Region. Tourism Management. 28(1). pp.307-316.</p>
          </li>
          <li><p>Barnes, D., 2008. Operations management: an international perspective. Cengage Learning EMEA.</p>
          </li>
          <li><p>Buckley, R., 2007. Adventure tourism products: Price, duration, size, skill, remoteness. Tourism management. 28(6). pp.1428-1433.</p>
          </li>
          <li><p>Buckley, R., 2011. Tourism and environment. Annual Review of Environment and Resources. 36. pp.397-416.</p>
          </li>
          <li><p>Cochrane, J. and Tapper, R., 2006. Tourism’s contribution to World Heritage Site management. Managing world heritage sites. pp.97-109.</p>
          </li>
        </ul>
    </div>
  </div>
