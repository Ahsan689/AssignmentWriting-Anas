...
export default function Bussiness1() {
    return (
<div>
  <Header/>
  ...
  <div className="main">
        ...
        <div className="row align-items-center justify-content-center">
          <div className="col-md-9 col-lg-7">
            <div className="page-header-content text-white text-center pt-sm-5 pt-md-5 pt-lg-0">
              <h2 className="text-white mb-0">Free Samples of Business </h2>
    ...
    {/*hero section end*/}
    <div className="container">
      <h2 className="text-center">Get the Best Business to Improve Your Grade
      </h2>
      ...
      <div className="row row-4 justify-content-around">
        <div className="col-md-5 card">
          {/* sub row start */}
          <div className="row">
            <h3 className="text-center"><Link to="/Bussiness2">Pearson BTEC Level Business Strategy Unit 7 Business Strategy </Link></h3>
        ...
        <div className="col-md-5 card">
          <div className="row">
            <h3 className="text-center"><Link to="/Bussiness3">Improving Business Perfomance 6LO500 Spring Terms 2017 University of Derby</Link></h3>
            <div className="col-md-8">
              <h5>Numbers of Pages:</h5>
            </div>
            <div className="col-md-4">
      ...
      <div className="row row-4 justify-content-center">
        <div className="col-md-5 card">
          <div className="row">
            <h3 className="text-center"><Link to="/Bussiness2">Unit 9:Management Accounting,Costing and Budgeting Pearson BTEC level 5</Link></h3>
            <div className="col-md-8">
              <h5>Numbers of Pages:</h5>
            </div>
            <div className="col-md-4">
