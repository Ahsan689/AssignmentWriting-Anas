...
export default function Education3() {
    return (
<div>
    <Header/>
  ...
  <div className="main">
        ...
        <div className="row align-items-center justify-content-center">
          <div className="col-md-9 col-lg-7">
            <div className="page-header-content text-white text-center pt-sm-5 pt-md-5 pt-lg-0">
              <h2 className="text-white mb-0">Student Plagiarism And Professional Practice
              </h2>
    ...
    <br />
    <div className="container">
      <h3 className="text-center ico" style={{borderBottom: '12px solid  black'}}>Report on Student Plagiarism And Professional Practice
      </h3>
      <p>Student plagiarism and professional practice
      </p>
      ...
      <ul>
        <li><p>Angélil-Carter, S. (2014). Stolen language?: Plagiarism in writing. Routledge.</p>
        </li>
        <li><p>Elander, J. and et.al., (2010). Evaluation of an intervention to help students avoid unintentional
            plagiarism by improving their authorial identity. Assessment &amp; Evaluation in Higher Education.
            35(2). 157-171.</p>
        </li>
        <li><p>Evering, L. C., &amp; Moorman, G. (2012). Rethinking plagiarism in the digital age. Journal of
            Adolescent &amp; Adult Literacy. 56(1). 35-44.</p>
        </li>
        <li><p>Falchikov, N. (2013). Improving assessment through student involvement: Practical solutions for
            aiding learning in higher and further education. Routledge.</p>
        </li>
        <li><p>Heitman, E., &amp; Litewka, S. (2011, February). International perspectives on plagiarism and
            considerations for teaching international trainees. In Urologic Oncology: Seminars and Original
            Investigations (Vol. 29, No. 1, pp. 104-108). Elsevier.</p>
        </li>
        <li><p>Jiang, H., Emmerton, L., &amp; McKauge, L. (2013). Academic integrity and plagiarism: a review of the
            influences and risk situations for health students.Higher Education Research &amp; Development. 32(3).
            369-380.</p>
        </li>
        <li><p>Kift, S. M., Nelson, K. J., &amp; Clarke, J. A. (2010). Transition pedagogy: a third generation approach
            to FYE: a case study of policy and practice for the higher education sector. The International
            Journal of the First Year in Higher Education. 1(1). 1-20.</p>
        </li>
