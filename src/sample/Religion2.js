...
export default function Religion2() {
    return (
<div>
    <Header/>
  ...
  <div className="main">
    ...
    <div className="container">
      <h3 className="text-center ico" style={{borderBottom: '12px solid black'}}> Report on Religious Beliefs and Values Level 4
      </h3>
      <h3>Introduction</h3>
