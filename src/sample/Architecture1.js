...
export default function Architecture1() {
    return (
<div>
    <Header/>
  ...
  <div className="main">
        ...
        <div className="row align-items-center justify-content-center">
          <div className="col-md-9 col-lg-7">
            <div className="page-header-content text-white text-center pt-sm-5 pt-md-5 pt-lg-0">
              <h2 className="text-white mb-0">Free Samples of Architecture </h2>
    ...
    {/*hero section end*/}
    <div className="container">
      <h2 className="text-center">Free Samples of Architecture
      </h2>
      <span className="animate-border mr-auto ml-auto mb-4" />
      {/* <span class="m-auto"><i class="fas fa-arrow-circle-down arrow text-center"></i></span> */}
      <div className="row row-4 justify-content-around mt-5">
        <div className="col-md-5 card">
          {/* sub row start */}
          <h3 className="text-center"><Link to="/Architecture2"> Construction Method</Link></h3>
          <div className="row">
        ...
        <div className="col-md-5 card">
          <h3 className="text-center"><Link to="/Architecture3">Enterprise Architecture Sample</Link></h3>
          <div className="row">
            <div className="col-md-8">
              <h5>Numbers of Pages:</h5>
            </div>
