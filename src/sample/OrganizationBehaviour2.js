...
export default function OrganizationBehaviour2() {
    return (
<div>
    <Header/>
  ...
  <div className="main">
        ...
        <div className="row align-items-center justify-content-center">
          <div className="col-md-9 col-lg-7">
            <div className="page-header-content text-white text-center pt-sm-5 pt-md-5 pt-lg-0">
              <h2 className="text-white mb-0">Effective Organisation and The Consultancy Process-Level 4
              </h2>
    ...
    <div className="container">
      <h3 className="ico text-center" style={{borderBottom: '12px solid black'}}>Report on Effective
      ...
      <p>Concept of Total Quality Management
      </p>
      ...
      <p>The a hit implementation of Total Quality Management need to consist of technical in addition to human
        ...
        extrinsic sources</p>
      <p>Tools of Total Quality Management
      </p>
      ...
      <p>Critically comparing the volume to which TQM can enhance organisational effectiveness</p>
