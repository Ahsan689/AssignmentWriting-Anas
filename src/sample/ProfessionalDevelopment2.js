...
export default function ProfessionalDevelopment2() {
    return (
<div>
    <Header/>
  ...
  <div className="main">
    ...
    <div className="main">
          ...
          <div className="row align-items-center justify-content-center">
            <div className="col-md-9 col-lg-7">
              <div className="page-header-content text-white text-center pt-sm-5 pt-md-5 pt-lg-0">
                <h2 className="text-white mb-0">Professional Development and Practice
                </h2>
      ...
      <div className="container">
        <h3 className="ico text-center" style={{borderBottom: '12px solid black'}}>Report on Professional
        ...
        <p>The impact of declining in sales of Sainsbury on the profitability of firm.
        </p>
        ...
        <p>Strategies through which declining in sales could be overcome.
        </p>
