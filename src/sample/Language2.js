...
export default function Language2() {
  ...
  <div className="main">
        ...
        <div className="row align-items-center justify-content-center">
          <div className="col-md-9 col-lg-7">
            <div className="page-header-content text-white text-center pt-sm-5 pt-md-5 pt-lg-0">
              <h2 className="text-white mb-0">Women’s Language
              </h2>
    ...
    <br />
    <div className="container">
      <h3 className="text-center ico" style={{borderBottom: '12px solid black'}}>Presentation to Women’s Language</h3>
      ...
      <h3>Highlights of women’s language</h3>
      ...
      <h4>Sociolinguistics history</h4>
      ...
      <ul>
        <li><p>Baxter, J., 2012. Ladies of the organization: A sociolinguistic point of view of senior women’s
            administration dialect within the UK. Diary of sociolinguistics,16(1). pp.81-107.</p></li>
        <li><p>Berger, S. G., 2013. Women’s words: The women's activist hone of verbal history. Routledge.</p></li>
        <li><p>Cook, H. M., 2011. Are honorifics respectful? Employments of referent honorifics in a Japanese
            committee assembly. Diary of Pragmatics. 43(15). pp.3655-3672.</p></li>
        <li><p>De Fina, A. and Ruler, K. A., 2011. Dialect issue or dialect struggle? Stories of foreigner women’s
            encounters within the US. Talk Ponders. 13(2). pp.163-188.</p></li>
        <li><p>Eckert,P. and McConnell-Ginet, C., 2013. Dialect and Sexual orientation. Cambridge College
            Press.pp.120-125.</p></li>
        <li><p>Erickson, B., Lind, E. A., Johnson, B. C. and O’Barr, W. M., 1978. Discourse fashion and impression
            arrangement in a court setting: The impacts of “powerful” and “powerless” discourse. Diary of
            Exploratory Social Brain research. 14(3). pp.266-279.</p></li>
        <li><p>Ervin-Tripp, S., 2014. Social Mental Viewpoints: Chosen Papers from the Primary Worldwide Conference
            on Social Brain research and Dialect held at the College of Bristol, Britain. Elsevier.</p></li>
        <li><p>Cheerful, V., Hicks, D. L., Santacreu-Vasut, E. and Shoham, A., 2015. Breaking down Culture: Can
            Gendered Dialect Impact Women’s Financial Engagement?. Fox School of Commerce Term Paper. Pp.15-046.</p>
        </li>
        <li><p>Guillaume, L., 2014. Japanese Advancement and” Women’s Language.</p></li>
      </ul>
    </div>
  </div>
  <Footer/>
