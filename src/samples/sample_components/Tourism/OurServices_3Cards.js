          ...
          <div className="row justify-content-center">
            <div className="col-md-10">
              <div className="section-heading text-center mb-5">
                ...
                <h2 className="mb-5">
                  Get the Best Tourism to Improve Your Grade
                </h2>
                <hr></hr>
              </div>
            </div>
          ...
          <div className="row justify-content-center">
            ...
            <div className="col-lg-6 col-md-6 col-sm-6">
              ...
              >
                ...
                <Link
                  to="/TourismContentComp3"
                  style={{ textDecoration: "none" }}
                >
                  <h5 className="mb-4 text-center">Contemporary issues in Travel And Tourism</h5>
                  <hr></hr>
                </Link>
                {/* <a href="services-details.html" target="_blank" className="detail-link mt-4">Read more <span
                                className="ti-arrow-right"></span></a> */}
