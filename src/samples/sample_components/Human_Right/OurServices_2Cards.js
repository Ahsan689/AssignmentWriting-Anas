          ...
          <div className="row justify-content-center">
            <div className="col-md-10">
              <div className="section-heading text-center mb-5">
                ...
                <h2 className="mb-5">
                  Get the Best Human Rights to Improve Your Grade
                </h2>
                <hr></hr>
              </div>
            </div>
          ...
          <div className="row">
            <div className="col-lg-6 col-md-6 col-sm-6 mb-2">
              ...
              >
                ...
                <Link
                  to="/HumanRightContentComp1"
                  style={{ textDecoration: "none" }}
                >
                  <h5 className="mb-4 text-center">
                    An analysis of the impact of total quality management in
            ...
            <div className="col-lg-6 col-md-6 col-sm-6">
              ...
              >
                ...
                <Link
                  to="/HumanRightContentComp2"
                  style={{ textDecoration: "none" }}
                >
                  <h5 className="mb-4 text-center">
                  Modern Movement Democracy Effect Architecture Sample
                  </h5>
                  <hr></hr>
                </Link>
                <strong>Number of pages: </strong>
