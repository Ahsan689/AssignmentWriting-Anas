          ...
          <div className="row justify-content-center">
            <div className="col-md-10">
              <div className="section-heading text-center mb-5">
                ...
                <h2 className="mb-5">
                  Get the Best Management to Improve Your Grade
                </h2>
                <hr></hr>
              </div>
            </div>
          ...
          <div className="row">
            <div className="col-lg-6 col-md-6 col-sm-6 mb-2">
              ...
              >
                ...
                <Link
                  to="/ManagementContentComp1"
                  style={{ textDecoration: "none" }}
                >
                  <h5 className="mb-4 text-center">
                    H/508/0489 Management Accounting Unit 5 Level 5
                  </h5>{" "}
                  <hr></hr>
                </Link>
            ...
            <div className="col-lg-6 col-md-6 col-sm-6">
              ...
              >
                ...
                <Link
                  to="/ManagementContentComp2"
                  style={{ textDecoration: "none" }}
                >
                  <h5 className="mb-4 text-center">Total Quality Management</h5>
                  <hr></hr>
                </Link>
                <strong>Number of pages: </strong>
                &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&ensp;
