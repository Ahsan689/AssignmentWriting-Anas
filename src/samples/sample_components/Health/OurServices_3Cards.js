          ...
          <div className="row justify-content-center">
            <div className="col-md-10">
              <div className="section-heading text-center mb-5">
                ...
                <h2 className="mb-5">
                  Get the Best Health to Improve Your Grade
                </h2>
                <hr></hr>
              </div>
            </div>
          ...
          <div className="row justify-content-center">
            <div className="col-lg-6 col-md-6 col-sm-6 mb-2">
              ...
              >
                ...
                <Link
                  to="/HealthContentComp1"
                  style={{ textDecoration: "none" }}
                >
                  <h5 className="mb-4 pb-3 text-center">Oxygen Therapy</h5>
                  <hr></hr>
                </Link>
            ...
            <div className="col-lg-6 col-md-6 col-sm-6 mb-2">
              ...
              >
                ...
                <Link
                  to="/HealthContentComp2"
                  style={{ textDecoration: "none" }}
                >
                  <h5 className="mb-2 text-center">
                    An investigation of a clinical governance or clinical
                    practice issue
                  </h5>
                  <hr></hr>
                </Link>
            ...
            <div className="col-lg-6 col-md-6 col-sm-6">
              ...
              >
                ...
                <Link
                  to="/HealthContentComp3"
                  style={{ textDecoration: "none" }}
                >
                  <h5 className="mb-4 text-center">
                    Number of pages: 9 Writer’s Qualifications: Graduation
                    Academic level: Diploma Tags: Top Universities In UK
                  </h5>
                  <hr></hr>
                </Link>
                {/* <a href="services-details.html" target="_blank" className="detail-link mt-4">Read more <span
