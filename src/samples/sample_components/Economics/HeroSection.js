...
export default function HeroSection() {
  return (
    <div>
      ...
      <section className="ptb-100" style={{backgroundImage: 'url(img/backgrounds/pexels-photo-4559532.jpeg)', backgroundRepeat:'no-repeat',backgroundPosition:"center",backgroundSize:'cover'}}>
            ...
            <div className="row align-items-center">
                <div className="col-md-12 col-lg-10">
                    <div className="hero-slider-content text-white pt-5">
                        ...
                        <h1 className="text-white pt-5 mb-5">  <Typical loop={Infinity} wrapper ='b' steps={[1200,'',1200,'Economics' ]}/>  Samples
                        </h1>
