...
<div>
  ...
  <div className="main">
        ...
        <div className="row align-items-center justify-content-center">
          <div className="col-md-9 col-lg-7">
            <div className="page-header-content text-white text-center pt-sm-5 pt-md-5 pt-lg-0">
              <h1 className="text-white mb-0">Rewiews</h1>
              <p>The Assignment Writing</p>
              <h5 className="text-white">Still In Two Minds? Check Our Genuine Reviews!<br />Listen To Our 98%
                Happy Clients</h5>
              <h2 className="text-white">4.9/5</h2>
    ...
    <br />
    <div className="container">
      <h2 className="recently text-center">Recently Added Reviews</h2>
      <span className="animate-border mr-auto ml-auto mb-4" />
      <h3 className="text-center para1"><a href="wattsapp review.php">Recently Wattsapp Reviews</a></h3>
      <span className="animate-border mr-auto ml-auto mb-4" />
      <div className="row justify-content-around">
        {/* <div class="row justify-content-around"> */}
        <div className="col-md-3 box ">
          <h5>Thanks</h5>
          <h6>Veronica / Ronni</h6>
          <p>25 Feb 2021</p>
          <span className="fa fa-star rating" />
          <span className="fa fa-star rating" />
          <span className="fa fa-star rating" />
          ...
          <p><b>User ID – 12484 |</b></p>
        </div>
        <div className="col-md-3 box">
          <h5>Extremely grateful</h5>
          <h6>John Burger / Driff</h6>
          <p>01 jan 2021</p>
          <span className="fa fa-star rating" />
          <span className="fa fa-star rating" />
          <span className="fa fa-star rating" />
      ...
      <div className="row justify-content-around mt-3">
        ...
        <div className="col-md-3 box ">
          ...
          <p><b>User ID – 13628 |</b></p>
        </div>
      </div>
      {/* row 2 end */}
      <div className="row justify-content-around row-3 mt-3"> 
        <div className="col-md-3 box">
          <h5>Thanks</h5>
          <h6>William / Smit</h6>
          <p>25 Feb 2021</p>
        ...
        <div className="col-md-3 box">
          ...
          <p>After struggling a lot with my thesis, I<br /> decided to take help from a professional.<br /> This
            ...
            believe
            the thesis. It was just amazing. Thanks people! </p>
          <p><b>User ID – 12459 |</b></p>
        </div>
      </div>
    </div>
    {/* </div>
